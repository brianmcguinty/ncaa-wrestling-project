...
$display_string .= "<br/>";
$display_string .= "<form name='submitAllAmericans'>";
$display_string .= "<input type='button' class='styled-button' onclick='submitAllAmericanPlacementPicks($contest_weight)' value='Submit $contest_weight AAs' />";
$display_string .= "</form>";
	$display_string .= "</td>";
...
{
	$display_string .= "<br/>";
	$display_string .= "<form name='submitBoutByBout'>";
	$display_string .= "<input type='button' class='styled-button' onclick='getBracketSheet(125)' value='Get Bracket' />";
	//$display_string .= "<input class='example4demo' type='button' onclick='getBracketSheet(125)' value='Get Bracket' />";
	//$display_string .= "<input class='fixedAjaxDOMWindow' type='button' onclick='getBracketSheet(125)' value='Get Bracket' />";
	$display_string .= "</form>";
	echo $display_string;
